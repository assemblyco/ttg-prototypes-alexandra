...
export default class InfiniteScroll extends Component {
  ...
  _onLongPressButton(){
    Alert.alert("You pressed the button too long. It doesn't like it")
  }
    ...
    return (
      <View style={styles.container}>
        <View style={{backgroundColor: "aliceblue"}}>
          ...
          <Text>ScrollViews are good for small lists with limited amount of items as it renders them all at once.</Text>
        </View>
        ...
        <ScrollView>
          ...
          <View style={styles.nestedContainer }>
            ...
            {/*TouchableNativeFeedback is for Android only*/}
        ...
        <View style={{backgroundColor: 'aliceblue'}}>
          ...
          <Text>SectionList is a List View good for API calls that return an infinite amount of data but you want it structured e.g. an alpabetically structured contacts list</Text>
        </View>
